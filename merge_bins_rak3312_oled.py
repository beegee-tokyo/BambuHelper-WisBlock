...
BUILD_DIR = '.pio/build/rak3312-oled'
BOOTLOADER = os.path.join(BUILD_DIR, 'bootloader.bin')
PARTITIONS = os.path.join(BUILD_DIR, 'partitions.bin')
FIRMWARE = os.path.join(BUILD_DIR, 'firmware.bin')

OUTPUT_DIR = 'firmware'
OUTPUT_MERGED = os.path.join(OUTPUT_DIR, 'BambuHelper-WebFlasher_rak3312-oled.bin')
OUTPUT_OTA = os.path.join(OUTPUT_DIR, 'BambuHelper-OTA_rak3312-oled.bin')
...
def merge_binaries():
    fw_name = f'BambuHelper-WebFlasher-RAK3312-OLED-v{version_tag_1}.{version_tag_2}.bin'
